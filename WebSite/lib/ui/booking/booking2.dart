...
class _BookNow2ScreenState extends State<BookNow2Screen> {
  ...
  _getList() {
    ...
    String _couponInfo = couponInfo(_mainModel.currentService.providers, _mainModel.currentService.category,
        ...
        strings.get(102), /// "Coupon not found",
        strings.get(103), /// "Coupon has expired",
        strings.get(104), /// "Coupon not supported by this provider",
        strings.get(105), /// "Coupon not support this category",
        strings.get(106), /// "Coupon not support this service",
        strings.get(107) /// "Coupon activated",
    );
    ...
    Widget _couponCode = Container(
        ...
        child: Column(
          children: [
            Edit37(
              hint: strings.get(101), /// "Coupon Code",
              icon: Icons.email,
