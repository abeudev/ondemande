...
class _CheckOut1ScreenState extends State<CheckOut1Screen> {
  ...
  _body(){
    ...
    String _couponInfo = couponInfo(_mainModel.currentService.providers,
        _mainModel.currentService.category,
        _mainModel.currentService.id,
        strings.get(162), /// "Coupon not found",
        strings.get(169), /// "Coupon has expired",
        strings.get(164), /// "Coupon not supported by this provider",
        strings.get(165), /// "Coupon not support this category",
        strings.get(166), /// "Coupon not support this service",
        strings.get(163) /// "Coupon activated",
    );
          ...
          children: [
            ...
            if (cartCouponCode.isNotEmpty)
              Center(child: Text(_couponInfo,
                style: theme.style13W800, textAlign: TextAlign.center,))
          ],
        )));
