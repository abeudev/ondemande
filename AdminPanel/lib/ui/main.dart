...
class _Dashboard2ScreenState extends State<Dashboard2Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (user == null) {
      ...
      drawState(_state, (String val){_state = val; _redraw();}, context, _redraw, strings.locale, _waits, windowWidth, windowHeight);
      return Scaffold(
          backgroundColor: dashboardColorCardGrey,
          body: LoginScreen()
          );
    ...
    if (_state == "listService")
      _child = ListServiceScreen();
    if (_state == "repair")
      _child = RepairScreen();

    drawState(_state, (String _){}, context, _redraw, strings.locale, _waits, windowWidth, windowHeight);
    ...
    return Scaffold(
        ...
        drawer: Menu4(context: context, callback: _routeMenu2, data: menu1, header: header(), noPop: false,
            ...
            select : _state, bkgColor: (theme.darkMode) ? theme.blackColorTitleBkg : colorBackground
        ),
